    ...
    <section className="py-20 bg-white dark:bg-slate-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20 max-w-4xl mx-auto text-center">
          ...
          >
            We provide a centralized space to explore opportunities, apply with ease, and navigate your career journey. With thousands of applications submitted daily, The jobsync.com empowers you to connect with employers who value your talent.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            ...
            <div className="text-slate-600 dark:text-slate-400 leading-relaxed text-[15px] md:text-[16px] font-medium italic transition-colors duration-300">
              <p>
                "The jobsync.com enables organizations to connect with top talent effortlessly, managing the entire recruitment lifecycle—from job posting to placement, and rebuttals—all within one seamless platform."
              </p>
            </div>
          </div>
