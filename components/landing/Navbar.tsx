...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-full top-0 z-50 bg-white/90 dark:bg-[#010a18]/90 backdrop-blur-md shadow-sm border-b border-[#90E0EF]/30 dark:border-[#0077B6]/20 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="lg:hidden flex items-center">
            <button onClick={() => setIsOpen(!isOpen)} className="text-[#03045E] dark:text-[#CAF0F8] hover:text-[#0077B6] transition-colors">
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="lg:hidden bg-white dark:bg-[#010a18] border-t border-[#90E0EF]/30 dark:border-[#0077B6]/20 px-4 py-4 space-y-4 shadow-lg absolute w-full z-50">
