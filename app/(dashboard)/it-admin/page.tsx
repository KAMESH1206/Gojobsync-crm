    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '1rem', marginBottom: '1.5rem' }}>
        {[
          ...
          { label: 'CPU Usage', value: '34%', icon: <Cpu size={18} />, color: '#3b82f6', status: 'healthy' },
          { label: 'Memory Usage', value: '62%', icon: <HardDrive size={18} />, color: '#f97316', status: 'warning' },
          { label: 'Active Connections', value: '23', icon: <Wifi size={18} />, color: '#8b5cf6', status: 'healthy' },
        ].map((s, i) => (
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(380px, 1fr))', gap: '1rem' }}>
            ...
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: '0.625rem', padding: '0.625rem 0', borderBottom: '1px solid var(--border)', alignItems: 'center' }}>
                <div style={{
                  ...
                  background: log.type === 'success' ? '#22c55e' : log.type === 'warning' ? '#eab308' : log.type === 'danger' ? '#ef4444' : '#3b82f6',
                }} />
        ...
        <div className="card animate-fade-in-up delay-4" style={{ padding: '1.25rem' }}>
          ...
          {[
            ...
            { label: 'Last Backup', status: '15 min ago', icon: <Database size={14} />, color: '#3b82f6' },
