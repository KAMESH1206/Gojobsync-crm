  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border"><div className="flex items-center gap-3 mb-3"><div className="bg-indigo-100 p-2 rounded-lg"><Building className="w-5 h-5 text-indigo-600" /></div><span className="text-sm text-gray-500">Companies</span></div><p className="text-3xl font-bold text-gray-800">{stats?.totalCompanies || 0}</p></div>
      ...
      <div className="bg-white rounded-xl shadow-sm border p-6">
        ...
        <div className="space-y-4">
          ...
          <div><div className="flex justify-between text-sm mb-1"><span className="text-gray-600">Company Partnerships</span><span className="font-medium">{stats?.totalCompanies || 0}</span></div><div className="w-full bg-gray-100 rounded-full h-3"><div className="bg-indigo-600 h-3 rounded-full" style={{ width: `${Math.min((stats?.totalCompanies || 0) * 5, 100)}%` }}></div></div></div>
